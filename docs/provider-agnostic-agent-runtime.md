...
**新增/调整的文件**：
- `apps/electron/src/main/lib/agent-runtime/attachment-enrichment.ts`：图片 base64 读取、文档文本提取、历史消息批量富化
...
| `agent-runtime/attachment-enrichment.test.ts` | 9 | 文档附件富化、图片附件过滤、空附件/失败降级 |
