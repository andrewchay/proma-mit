...
import type { AgentThinkingLevel, ChatMessage, FileAttachment, ProviderType } from '@gravitas/shared'
...
export interface StreamRequestInput {
  ...
  /** 思考强度分级；存在时优先于 thinkingEnabled，按 reasoning profile 的 effortMap 编码 */
