...
const matrix: readonly RealCase[] = [
  ...
  { provider: 'deepseek-openai', apiKeyEnv: 'PROMA_AI_SDK_DEEPSEEK_API_KEY', fallbackApiKeyEnv: 'DEEPSEEK_API_KEY', modelEnv: 'PROMA_AI_SDK_DEEPSEEK_OPENAI_MODEL', model: 'deepseek-chat', baseUrlEnv: 'PROMA_AI_SDK_DEEPSEEK_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['deepseek-openai'] },
  ...
  { provider: 'qwen-anthropic', apiKeyEnv: 'PROMA_AI_SDK_QWEN_ANTHROPIC_API_KEY', fallbackApiKeyEnv: 'DASHSCOPE_API_KEY', modelEnv: 'PROMA_AI_SDK_QWEN_ANTHROPIC_MODEL', model: 'qwen-turbo', baseUrlEnv: 'PROMA_AI_SDK_QWEN_ANTHROPIC_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['qwen-anthropic'] },
  { provider: 'qwen-token-plan', apiKeyEnv: 'PROMA_AI_SDK_QWEN_TOKEN_PLAN_API_KEY', modelEnv: 'PROMA_AI_SDK_QWEN_TOKEN_PLAN_MODEL', model: 'qwen3.8-max-preview', baseUrlEnv: 'PROMA_AI_SDK_QWEN_TOKEN_PLAN_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['qwen-token-plan'] },
  { provider: 'openai-responses', apiKeyEnv: 'PROMA_AI_SDK_OPENAI_RESPONSES_API_KEY', fallbackApiKeyEnv: 'OPENAI_API_KEY', modelEnv: 'PROMA_AI_SDK_OPENAI_RESPONSES_MODEL', model: 'gpt-4o-mini', baseUrlEnv: 'PROMA_AI_SDK_OPENAI_RESPONSES_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['openai-responses'] },
  { provider: 'ark-coding-plan', apiKeyEnv: 'PROMA_AI_SDK_ARK_CODING_PLAN_API_KEY', modelEnv: 'PROMA_AI_SDK_ARK_CODING_PLAN_MODEL', model: 'doubao-seed-2.0-code', baseUrlEnv: 'PROMA_AI_SDK_ARK_CODING_PLAN_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['ark-coding-plan'] },
  { provider: 'zhipu-coding', apiKeyEnv: 'PROMA_AI_SDK_ZHIPU_CODING_API_KEY', modelEnv: 'PROMA_AI_SDK_ZHIPU_CODING_MODEL', model: 'glm-5.3', baseUrlEnv: 'PROMA_AI_SDK_ZHIPU_CODING_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['zhipu-coding'] },
  { provider: 'zhipu-coding-team', apiKeyEnv: 'PROMA_AI_SDK_ZHIPU_CODING_TEAM_API_KEY', modelEnv: 'PROMA_AI_SDK_ZHIPU_CODING_TEAM_MODEL', model: 'glm-5.3', baseUrlEnv: 'PROMA_AI_SDK_ZHIPU_CODING_TEAM_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS['zhipu-coding-team'] },
  { provider: 'xai', apiKeyEnv: 'PROMA_AI_SDK_XAI_API_KEY', fallbackApiKeyEnv: 'XAI_API_KEY', modelEnv: 'PROMA_AI_SDK_XAI_MODEL', model: 'grok-3-mini', baseUrlEnv: 'PROMA_AI_SDK_XAI_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS.xai },
  { provider: 'xiaomi', apiKeyEnv: 'PROMA_AI_SDK_XIAOMI_API_KEY', modelEnv: 'PROMA_AI_SDK_XIAOMI_MODEL', model: 'mimo-v2.5-flash', baseUrlEnv: 'PROMA_AI_SDK_XIAOMI_BASE_URL', baseUrl: PROVIDER_DEFAULT_URLS.xiaomi },
]
