...
def main():
    ...
    parser.add_argument("--output", default=None, help="输出 CSV 文件名（写入当前会话目录）")
    args = parser.parse_args()

    config_path = args.config if os.path.isabs(args.config) else os.path.join(SESSION_DIR, args.config)
