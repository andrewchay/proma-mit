...
# Gravitas Icon Generation Script
...
echo "🎨 Generating Gravitas icons..."
...
TRAY_SVG="gravitas-logos/icon.svg"

if [ ! -f "$TRAY_SVG" ]; then
  echo "⚠️  Tray icon SVG not found at $TRAY_SVG, skipping tray icon generation"
else
  # 生成多分辨率 Template 图标（macOS 会自动选择合适的版本）
  rsvg-convert -w 22 -h 22 "$TRAY_SVG" -o gravitas-logos/iconTemplate.png
  rsvg-convert -w 44 -h 44 "$TRAY_SVG" -o "gravitas-logos/iconTemplate@2x.png"
  rsvg-convert -w 66 -h 66 "$TRAY_SVG" -o "gravitas-logos/iconTemplate@3x.png"

  echo "✅ Tray icons generated:"
  echo "   - gravitas-logos/iconTemplate.png (22x22 @1x)"
  echo "   - gravitas-logos/iconTemplate@2x.png (44x44 @2x Retina)"
  echo "   - gravitas-logos/iconTemplate@3x.png (66x66 @3x)"
fi
...
echo "  - gravitas-logos/iconTemplate.png - macOS tray (22x22 @1x)"
echo "  - gravitas-logos/iconTemplate@2x.png - macOS tray (44x44 @2x Retina)"
echo "  - gravitas-logos/iconTemplate@3x.png - macOS tray (66x66 @3x)"
