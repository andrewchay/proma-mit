...
export type ActiveView = 'conversations' | 'workflow' | 'proactive' | 'knowledge' | 'analysis' | 'projects' | 'calendar' | 'influencer' | 'paid-media' | 'outbound-sourcing' | 'new-media' | 'research' | 'capabilities'
