...
import type { EnvironmentCheckResult, RuntimeStatus } from '@gravitas/shared'
import {
  SettingsSection,
  SettingsCard,
  SettingsRow,
...
const GITHUB_RELEASES_URL = 'https://github.com/andrewchay/proma-mit/releases'
...
function UpdateCard(): React.ReactElement | null {
  ...
  const [release, setRelease] = React.useState<import('@gravitas/shared').GitHubRelease | null>(null)
    ...
    >
      <SettingsCard>
        ...
        <SettingsRow label="项目地址">
          <a
            href="https://github.com/andrewchay/proma-mit"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-primary hover:underline"
          >
            github.com/andrewchay/proma-mit
          </a>
        </SettingsRow>
      </SettingsCard>
