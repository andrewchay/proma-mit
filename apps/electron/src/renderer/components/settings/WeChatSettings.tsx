...
import type { WeChatBridgeStatus } from '@gravitas/shared'
...
export function WeChatSettings(): React.ReactElement {
  ...
  return (
    <div className="space-y-8">
      ...
      <SettingsSection
        title="微信集成"
        description="扫码登录微信，在微信中控制 Gravitas Agent"
      >
        <SettingsCard>
        ...
        <SettingsCard divided={false}>
          <div className="px-4 py-4 space-y-5 text-sm">
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                扫码成功后，Gravitas 会自动建立长连接。
                凭证会加密保存，下次启动 Gravitas 时自动重连。
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                连接成功后，通过微信发送消息即可与 Gravitas Agent 交互。
                支持文本、图片、文件等消息类型。
              </p>
            </div>
