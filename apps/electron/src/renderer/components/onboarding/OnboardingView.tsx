      ...
      {step === 'welcome' && (
        <>
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4">欢迎使用 Gravitas</h1>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    了解 Gravitas 的全部功能和使用技巧
                  </p>
                </div>
              </button>

              <p className="text-sm text-muted-foreground pt-2">
                自己或身边的人已经在用 Gravitas？直接导入现有配置
              </p>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      ...
                      <br/>
                      <br/>
                      需要先在原设备上导出 .gravitas-backup 文件，再双击导入即可
                    </p>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      ...
                      <br/>
                      <br/>
                      需要先导出 .gravitas-share 文件，再双击导入即可
                    </p>
                  </div>
                </button>
              </div>
        ...
        <div className="w-full max-w-2xl">
          <div className="mb-6 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Gravitas 在 Windows 上需要 Git Bash 或 WSL 才能执行命令
            </p>
          </div>
