...
import {
  ...
  createInvokeAgentToolDefinition,
  executeInvokeAgentTool,
} from './tool-impls/agent-invoke-tool.ts'
import {
  AGENT_TOOL_NAME,
...
import {
  ...
  WEB_BRIDGE_OBSERVE_TOOL_NAME,
  WEB_BRIDGE_NEW_TAB_TOOL_NAME,
  WEB_BRIDGE_LIST_TABS_TOOL_NAME,
  WEB_BRIDGE_SELECT_TAB_TOOL_NAME,
  WEB_BRIDGE_CLOSE_TAB_TOOL_NAME,
  ...
  executeWebBridgeObserveTool,
  executeWebBridgeNewTabTool,
  executeWebBridgeListTabsTool,
  executeWebBridgeSelectTabTool,
  executeWebBridgeCloseTabTool,
...
export { ENTER_PLAN_MODE_TOOL_NAME, EXIT_PLAN_MODE_TOOL_NAME, ASK_USER_QUESTION_TOOL_NAME, AGENT_TOOL_NAME, GOAL_CHECKPOINT_TOOL_NAME, READ_SKILL_TOOL_NAME, TODO_CONTEXT_TOOL_NAME, COST_AUDIT_TOOL_NAME, PROPOSE_ASSET_TOOL_NAME, EXPLORE_CONTEXT_TOOL_NAME, INVOKE_AGENT_TOOL_NAME }
...
export function createCoreTools(options?: CreateCoreToolsOptions): RuntimeToolDefinition[] {
  const tools: RuntimeToolDefinition[] = [
    ...
    { ...createWebBridgeObserveToolDefinition(), execute: executeWebBridgeObserveTool },
    { ...createWebBridgeNewTabToolDefinition(), execute: executeWebBridgeNewTabTool },
    { ...createWebBridgeListTabsToolDefinition(), execute: executeWebBridgeListTabsTool },
    { ...createWebBridgeSelectTabToolDefinition(), execute: executeWebBridgeSelectTabTool },
    { ...createWebBridgeCloseTabToolDefinition(), execute: executeWebBridgeCloseTabTool },
  ]
